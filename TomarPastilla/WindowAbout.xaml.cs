...
vSetPorQueMierdaHiceEsto();
vSetLicencia();
}

void vSetPorQueMierdaHiceEsto()
{

TextBlockAbout.Text = 
"Hice esta aplicación simple, muy simple,\n" +
"porque estoy podrido de olvidarme de tomar\n"+
"la pastilla para la Hipertiroides.\n" +
"Espero dejar de olvidarme ahora..." +
"Viva Unión de Santa Fe!!!";
...
MyPastilla le ayuda a recordar que tiene que tomar sus pastilla diarias.
...
MegalÖSoft, Inc. mediante este documento renuncia a cualquier interés de derechos de copyright con respecto al programa Gnomovision (que hace pasadas a compiladores) escrito por GERMAN.
MegalÖSoft, 20 de diciembre de 1996
...
RichTextBoxLicencia.Document.Blocks.Add(new Paragraph(new Run(slicencia)));
